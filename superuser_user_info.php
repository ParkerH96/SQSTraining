...
//Add/remove group members
		...
		echo "User email: <input type=\"text\" name=\"username\" id=\"txt_superUsernameAdd\">";

		echo "Group to add to: <input type=\"text\" name=\"group_name\" id=\"txt_superGroupAdd\">";

		echo "<button class = \"btn btn-primary\" type=\"submit\" id=\"btn_superGroupAdd\" value=\"Add\"> Add </button>";
		echo "</form>";
		...
		echo "User email: <input type=\"text\" name=\"username\" id=\"txt_superUsernameRemove\">";

		echo "Group to remove from: <input type=\"text\" name=\"group_name\" id=\"txt_superGroupRemove\">";

		echo "<button class = \"btn btn-primary\" type=\"submit\" id=\"btn_superGroupRemove\" value=\"Remove\"> Remove </button>";
		echo "</form>";
		echo "</td>";
		echo "</tr>";
	/*	echo "<tr>";
